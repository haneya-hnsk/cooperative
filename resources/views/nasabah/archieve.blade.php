                            ...
                            <tbody>
                                @foreach ($nasabahs as $nasabah)
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            <form action="/archieve/nasabah/restore/{{ $nasabah->id }}" method="post">
                                            @csrf
                                                <input type="submit" value="Kembalikan" class="btn btn-success me-2" onclick="confirm('Yakin Akan Mengembalikan Nasabah ini?')">
